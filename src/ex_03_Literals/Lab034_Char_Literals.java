...
//        System.out.println("PramodDutta");
        ...
        System.out.println("Ragini"+new_line+"Priyanka"+new_line+"Sivaram");
        System.out.println("i am very good girl"+tab_line+"beautiful too");
        System.out.println("i am very good girl"+back_space+"beautiful too");
        System.out.println("i am very good girl"+carriage_return+"beautiful too");
